#
# Be sure to run `pod lib lint hqxModules.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'hqxModules'
  s.version          = '0.1.0'
  s.summary          = 'A short description of hqxModules.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'hqxModules/Classes/**/*'
  
  # s.resource_bundles = {
  #   'hqxModules' => ['hqxModules/Assets/*.png']
  # }
